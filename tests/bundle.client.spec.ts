...
describe('client bundle and package artifact', () => {
  ...
  it('keeps package metadata and the Web overlay fixture aligned', () => {
    ...
    expect(packageManifest.dsh.client.inject).not.toContain('@deepseek-ai/dsh-client-runtime')
    expect(packageManifest.dsh.client.inject).toContain('@deepseek-ai/dsh-client-connection')
    expect(packageManifest.dsh.client.inject).toContain('@deepseek-ai/dsh-client-ui-slots')
