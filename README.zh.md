...
| 上一个 Workspace | `Mod+Shift+ArrowLeft` | Workspace list、`connectWorkspace()` 和 `sessions.open()` |
| 下一个 Workspace | `Mod+Shift+ArrowRight` | Workspace list、`connectWorkspace()` 和 `sessions.open()` |
