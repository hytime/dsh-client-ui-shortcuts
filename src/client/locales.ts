...
export const zh = {
  ...
  'editor.save': '保存', 'editor.cancel': '取消', 'editor.record': '录入快捷键', 'editor.recording': '请按下快捷键…', 'editor.conflict': '快捷键与同组其他操作冲突。', 'editor.invalid': '解决冲突后才能保存。', 'editor.saveFailed': '自定义快捷键保存失败：{message}',
...
export const en = {
  ...
  'editor.save': 'Save', 'editor.cancel': 'Cancel', 'editor.record': 'Record shortcut', 'editor.recording': 'Press a shortcut…', 'editor.conflict': 'Shortcut conflicts with another command.', 'editor.invalid': 'Resolve conflicts before saving.', 'editor.saveFailed': 'Could not save custom shortcuts: {message}',
  'modifier.Mod': 'Mod', 'modifier.Ctrl': 'Ctrl', 'modifier.Alt': 'Alt', 'modifier.Meta': 'Meta', 'modifier.Shift': 'Shift',
